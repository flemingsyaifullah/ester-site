...
var middlewareSecret = "f3ebd5be-04c3-42f1-91d6-e15f1af8d918";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"SITE": "https://globalindoperizinan.id",
			"SSR": true
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/save-content",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/save-content\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/api/save-content.ts",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/save-portfolio",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/save-portfolio\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			}], [{
				"content": "save-portfolio",
				"dynamic": false,
				"spread": false
			}]],
			"params": [],
			"component": "src/pages/api/save-portfolio.ts",
			"pathname": "/api/save-portfolio",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/upload-image.ts",
...
var _page0 = () => import("./chunks/generic_BJUXRuRU.mjs");
var _page1 = () => import("./chunks/dashboard_Dw_s5YrY.mjs");
var _page2 = () => import("./chunks/login_CjB5_9vQ.mjs");
var _page3 = () => import("./chunks/index_BSUhHxvq.mjs");
var _page4 = () => import("./chunks/admin-login_6MumxkXn.mjs");
var _page5 = () => import("./chunks/admin-logout_CxNAHLBe.mjs");
var _page6 = () => import("./chunks/save-content_1IzL45ZL.mjs");
var _page7 = () => import("./chunks/save-portfolio_DC4PZTk-.mjs");
var _page8 = () => import("./chunks/upload-image_Dd9gwMFN.mjs");
var pageMap = /* @__PURE__ */ new Map([
	...
	["src/pages/api/save-content.ts", _page6],
	["src/pages/api/save-portfolio.ts", _page7],
	["src/pages/api/upload-image.ts", _page8]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/D/ester/ester-site/","cacheDir":"file:///C:/D/ester/ester-site/node_modules/.astro/","outDir":"file:///C:/D/ester/ester-site/dist/","srcDir":"file:///C:/D/ester/ester-site/src/","publicDir":"file:///C:/D/ester/ester-site/public/","buildClientDir":"file:///C:/D/ester/ester-site/dist/client/","buildServerDir":"file:///C:/D/ester/ester-site/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AdminLayout.CikL9CjD.css"}],"routeData":{"route":"/admin/dashboard","isIndex":false,"type":"page","pattern":"^\\/admin\\/dashboard\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"dashboard","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/dashboard.astro","pathname":"/admin/dashboard","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/AdminLayout.CikL9CjD.css"}],"routeData":{"route":"/admin/login","isIndex":false,"type":"page","pattern":"^\\/admin\\/login\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/login.astro","pathname":"/admin/login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin-login","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin-login\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin-login","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin-login.ts","pathname":"/api/admin-login","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/admin-logout","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/admin-logout\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"admin-logout","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/admin-logout.ts","pathname":"/api/admin-logout","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/save-content","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/save-content\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"save-content","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/save-content.ts","pathname":"/api/save-content","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/save-portfolio","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/save-portfolio\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"save-portfolio","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/save-portfolio.ts","pathname":"/api/save-portfolio","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/upload-image","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/upload-image\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"upload-image","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/upload-image.ts","pathname":"/api/upload-image","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/area-layanan/[kota]","isIndex":false,"type":"page","pattern":"^\\/area-layanan\\/([^/]+?)\\/?$","segments":[[{"content":"area-layanan","dynamic":false,"spread":false}],[{"content":"kota","dynamic":true,"spread":false}]],"params":["kota"],"component":"src/pages/area-layanan/[kota].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/blog/[slug]","isIndex":false,"type":"page","pattern":"^\\/blog\\/([^/]+?)\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/blog/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/blog","isIndex":true,"type":"page","pattern":"^\\/blog\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blog/index.astro","pathname":"/blog","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/brosur","isIndex":false,"type":"page","pattern":"^\\/brosur\\/?$","segments":[[{"content":"brosur","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/brosur.astro","pathname":"/brosur","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/jasa-pbg","isIndex":false,"type":"page","pattern":"^\\/jasa-pbg\\/?$","segments":[[{"content":"jasa-pbg","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/jasa-pbg.astro","pathname":"/jasa-pbg","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/jasa-slf","isIndex":false,"type":"page","pattern":"^\\/jasa-slf\\/?$","segments":[[{"content":"jasa-slf","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/jasa-slf.astro","pathname":"/jasa-slf","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/kontak","isIndex":false,"type":"page","pattern":"^\\/kontak\\/?$","segments":[[{"content":"kontak","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/kontak.astro","pathname":"/kontak","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/portofolio","isIndex":false,"type":"page","pattern":"^\\/portofolio\\/?$","segments":[[{"content":"portofolio","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/portofolio.astro","pathname":"/portofolio","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/tentang-kami","isIndex":false,"type":"page","pattern":"^\\/tentang-kami\\/?$","segments":[[{"content":"tentang-kami","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/tentang-kami.astro","pathname":"/tentang-kami","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://globalindoperizinan.id","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/D/ester/ester-site/src/pages/area-layanan/[kota].astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/blog/[slug].astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/blog/index.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/brosur.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/jasa-pbg.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/jasa-slf.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/kontak.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/portofolio.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/tentang-kami.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/admin/dashboard.astro",{"propagation":"none","containsHead":true}],["C:/D/ester/ester-site/src/pages/admin/login.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.B0EPL79k.mjs","\u0000virtual:astro:page:src/pages/area-layanan/[kota]@_@astro":"chunks/_kota__dXRL3ihO.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:page:src/pages/blog/[slug]@_@astro":"chunks/_slug__Czx3wSng.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/brosur@_@astro":"chunks/brosur_BgLO3UFw.mjs","\u0000virtual:astro:page:src/pages/blog/index@_@astro":"chunks/index_B-HhkhIN.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_ClwI6Sdy.mjs","\u0000virtual:astro:page:src/pages/jasa-pbg@_@astro":"chunks/jasa-pbg_C0F7rMmD.mjs","\u0000virtual:astro:page:src/pages/jasa-slf@_@astro":"chunks/jasa-slf_DOaqySfH.mjs","\u0000virtual:astro:page:src/pages/kontak@_@astro":"chunks/kontak_slDer_Kl.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/portofolio@_@astro":"chunks/portofolio_BOZByp6N.mjs","\u0000virtual:astro:page:src/pages/tentang-kami@_@astro":"chunks/tentang-kami_C_RTH5xm.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/admin-login@_@ts":"chunks/admin-login_6MumxkXn.mjs","\u0000virtual:astro:page:src/pages/api/admin-logout@_@ts":"chunks/admin-logout_CxNAHLBe.mjs","\u0000virtual:astro:page:src/pages/admin/dashboard@_@astro":"chunks/dashboard_Dw_s5YrY.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_BJUXRuRU.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_BSUhHxvq.mjs","\u0000virtual:astro:page:src/pages/admin/login@_@astro":"chunks/login_CjB5_9vQ.mjs","\u0000virtual:astro:page:src/pages/api/save-content@_@ts":"chunks/save-content_1IzL45ZL.mjs","\u0000virtual:astro:page:src/pages/api/save-portfolio@_@ts":"chunks/save-portfolio_DC4PZTk-.mjs","C:/D/ester/ester-site/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_hsOhIWDX.mjs","\u0000virtual:astro:page:src/pages/api/upload-image@_@ts":"chunks/upload-image_Dd9gwMFN.mjs","C:/D/ester/ester-site/src/components/Header.astro?astro&type=script&index=0&lang.ts":"_astro/Header.astro_astro_type_script_index_0_lang.BA6GUXzA.js","C:/D/ester/ester-site/src/pages/admin/dashboard.astro?astro&type=script&index=0&lang.ts":"_astro/dashboard.astro_astro_type_script_index_0_lang.CBi9n6KM.js","C:/D/ester/ester-site/src/pages/admin/login.astro?astro&type=script&index=0&lang.ts":"_astro/login.astro_astro_type_script_index_0_lang.Cx1eFEJ5.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/D/ester/ester-site/src/components/Header.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`menuBtn`),t=document.getElementById(`mobileMenu`);e?.addEventListener(`click`,()=>{let n=t?.classList.contains(`hidden`);t?.classList.toggle(`hidden`),t?.classList.toggle(`flex`),e.setAttribute(`aria-expanded`,String(n))});"],["C:/D/ester/ester-site/src/pages/admin/dashboard.astro?astro&type=script&index=0&lang.ts","var e=document.querySelectorAll(`.tab-btn`),t=document.querySelectorAll(`.tab-panel`);function n(n){e.forEach(e=>{let t=e.dataset.tab===n;e.classList.toggle(`bg-ink`,t),e.classList.toggle(`text-paper`,t),e.classList.toggle(`text-slate`,!t)}),t.forEach(e=>{e.classList.toggle(`hidden`,e.id!==`panel-${n}`)})}e.forEach(e=>e.addEventListener(`click`,()=>n(e.dataset.tab))),document.getElementById(`logoutBtn`)?.addEventListener(`click`,async()=>{await fetch(`/api/admin-logout`,{method:`POST`}),window.location.href=`/admin/login`});var r=document.getElementById(`imageInput`),i=document.getElementById(`imgPreview`),a=document.getElementById(`fotoPath`),o=document.getElementById(`uploadStatus`);r?.addEventListener(`change`,async()=>{let e=r.files?.[0];if(!e)return;i.src=URL.createObjectURL(e),o.textContent=`Mengupload foto...`;let t=new FormData;t.append(`image`,e);try{let e=await fetch(`/api/upload-image`,{method:`POST`,body:t}),n=await e.json();e.ok&&n.ok?(a.value=n.path,o.textContent=`✓ Foto berhasil diupload: ${n.path}`):o.textContent=`✗ Upload gagal: ${n.error}`}catch(e){o.textContent=`✗ Upload gagal: ${e}`}});var s=document.getElementById(`portfolioForm`),c=document.getElementById(`portfolioStatus`),l=document.getElementById(`savePortfolioBtn`);s?.addEventListener(`submit`,async e=>{e.preventDefault(),l.disabled=!0,l.textContent=`Menyimpan...`,c.textContent=``;let t=new FormData(s),n={proyek:[{id:`prodia-mojokerto`,nama:t.get(`nama`)?.toString()??``,klien:t.get(`klien`)?.toString()??``,lokasi:t.get(`lokasi`)?.toString()??``,foto:t.get(`foto`)?.toString()??`/images/prodia.jpg`,fotoAlt:t.get(`nama`)?.toString()??`Foto proyek`,deskripsi:t.get(`deskripsi`)?.toString()??``,capaian:[{kode:`PBG`,label:t.get(`pbg_label`)?.toString()??`Persetujuan Bangunan Gedung`,desc:t.get(`pbg_desc`)?.toString()??``},{kode:`SLF`,label:t.get(`slf_label`)?.toString()??`Sertifikat Laik Fungsi`,desc:t.get(`slf_desc`)?.toString()??``}]}]};try{let e=await fetch(`/api/save-portfolio`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify(n)}),t=await e.json();e.ok&&t.ok?c.textContent=`✓ Tersimpan! Website akan diperbarui dalam ~1–2 menit.`:c.textContent=`✗ Gagal: ${t.error}`}catch(e){c.textContent=`✗ Gagal: ${e}`}finally{l.disabled=!1,l.textContent=`Simpan Perubahan`}});var u=document.getElementById(`statsForm`),d=document.getElementById(`statsStatus`),f=document.getElementById(`saveStatsBtn`);u?.addEventListener(`submit`,async e=>{e.preventDefault(),f.disabled=!0,f.textContent=`Menyimpan...`,d.textContent=``;let t=new FormData(u),n=parseInt(t.get(`count`)?.toString()??`3`),r=[];for(let e=0;e<n;e++)r.push({angka:t.get(`angka_${e}`)?.toString()??``,label:t.get(`label_${e}`)?.toString()??``});try{let e=await fetch(`/api/save-content`,{method:`POST`,headers:{\"Content-Type\":`application/json`},body:JSON.stringify({alasan:r})}),t=await e.json();e.ok&&t.ok?d.textContent=`✓ Tersimpan! Website akan diperbarui dalam ~1–2 menit.`:d.textContent=`✗ Gagal: ${t.error}`}catch(e){d.textContent=`✗ Gagal: ${e}`}finally{f.disabled=!1,f.textContent=`Simpan Perubahan`}});"],["C:/D/ester/ester-site/src/pages/admin/login.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`loginForm`),t=document.getElementById(`submitBtn`),n=document.getElementById(`errorMsg`);e.addEventListener(`submit`,async r=>{r.preventDefault(),t.disabled=!0,t.textContent=`Memverifikasi...`,n.classList.add(`hidden`),n.textContent=``;let i=new FormData(e);try{let e=await fetch(`/api/admin-login`,{method:`POST`,body:i}),r=await e.json();e.ok&&r.ok?window.location.href=`/admin/dashboard`:(n.textContent=r.error??`Login gagal. Coba lagi.`,n.classList.remove(`hidden`),t.disabled=!1,t.textContent=`Masuk ke Panel Admin`)}catch{n.textContent=`Terjadi kesalahan jaringan. Coba lagi.`,n.classList.remove(`hidden`),t.disabled=!1,t.textContent=`Masuk ke Panel Admin`}});"]],"assets":["/favicon.ico","/favicon.svg","/robots.txt","/brosur/BROSUR PBG ESTER.pdf","/brosur/BROSUR SLF ESTER.pdf","/images/prodia.jpg","/_astro/Layout.CikL9CjD.css","/_astro/AdminLayout.CikL9CjD.css","/blog/index.html","/brosur/index.html","/jasa-pbg/index.html","/jasa-slf/index.html","/kontak/index.html","/portofolio/index.html","/tentang-kami/index.html","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"7Yg3WbaPhnSaGy/CO7kFILuERxJ/n4lx4GoxIz+F1sA=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});

...
export const posts: Post[] = [
  {
    slug: "apa-itu-pbg-beda-imb",
    title: "Apa Itu PBG dan Bedanya dengan IMB?",
    excerpt:
      "Sejak UU Cipta Kerja berlaku, IMB resmi digantikan PBG. Ini yang berubah dan yang perlu disiapkan pemilik bangunan.",
    date: "2026-01-12",
  ...
  {
    slug: "syarat-lengkap-pbg",
    title: "Syarat Lengkap Mengurus PBG untuk Bangunan Komersial dan Industri",
    excerpt:
      "Dari dokumen tanah sampai perhitungan struktur — ini daftar lengkap yang perlu disiapkan sebelum mendaftar PBG.",
    date: "2026-02-03",
  ...
  {
    slug: "slf-wajib-sebelum-beroperasi",
    title: "SLF Wajib Dimiliki Sebelum Bangunan Beroperasi, Ini Alasannya",
    excerpt:
      "PBG mengizinkan pembangunan, tapi SLF yang membuktikan bangunan itu benar-benar laik dan aman digunakan.",
    date: "2026-02-20",
  ...
  {
    slug: "berapa-lama-proses-pbg",
    title: "Berapa Lama Proses PBG? Ini Tahapannya dari Awal sampai Terbit",
    excerpt:
      "Sembilan tahap resmi pengurusan PBG lewat SIMBG, dari persiapan dokumen sampai retribusi dan penerbitan.",
    date: "2026-03-05",
    readTime: "4 menit baca",
    content: [
  ...
  {
    slug: "risiko-bangunan-tanpa-pbg",
    title: "Risiko Bangunan Tanpa PBG yang Perlu Diketahui Pemilik Usaha",
    excerpt:
      "Bangunan tanpa PBG bukan cuma soal administrasi — ada risiko operasional dan hukum yang mengikuti.",
    date: "2026-03-18",
    readTime: "3 menit baca",
    content: [
  ...
  {
    slug: "dasar-hukum-pbg-slf",
    title: "Dasar Hukum PBG dan SLF yang Perlu Diketahui Pemilik Bangunan",
    excerpt:
      "Dari UU Bangunan Gedung sampai Peraturan Menteri PUPR — ini payung hukum yang membuat PBG dan SLF wajib dimiliki.",
    date: "2026-04-02",
    readTime: "3 menit baca",
    content: [
  ...
  {
    slug: "slf-bangunan-lama-tanpa-pbg",
    title: "Bangunan Lama Belum Punya PBG? Begini Cara Mengurus SLF-nya",
    excerpt:
      "Bangunan yang sudah berdiri lama, bahkan sebelum era PBG, tetap bisa diproses menuju SLF lewat jalur kajian teknis bangunan eksisting.",
    date: "2026-04-18",
    readTime: "3 menit baca",
    content: [
  ...
  {
    slug: "perbedaan-detail-pbg-slf",
    title: "PBG vs SLF: Dua Dokumen yang Sering Tertukar Padahal Beda Fungsi",
    excerpt:
      "PBG menjawab 'boleh dibangun atau tidak', sedangkan SLF menjawab 'boleh dipakai atau tidak' — ini rincian perbedaannya.",
    date: "2026-05-10",
    readTime: "3 menit baca",
    content: [
